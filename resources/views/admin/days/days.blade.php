    ...
    <div id='day-users'>
        <div class="stats-container">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <h3>إجمالي وقت الحضور </h3>
                    <p id="sum-time">{{ $sumTime }}</p>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row py-3"><div class="col-lg-6">
                    <div class="dashboard-filters">
                        @php $days = 0 ; $days = \App\Models\Day::all(); @endphp
                        <span class="pt-2">{{ __('messages.Day') }}</span>
                        <select name="day_id" id='day_id' class='attandance-users-search form-control rounded mt-1 '>
                            <option value="all">{{ __('messages.All') }}</option>
                            @foreach($days as $key => $day)
                                <option value="{{$day->id}}">{{ $key + 1 }}</option>
                            @endforeach
                        </select>
                        @php $rooms = 0 ; $rooms = \App\Models\Room::all(); @endphp
                        <span class="pt-2">{{ __('messages.room') }}</span>
                        <select name="room_id" id='room_id' class='attandance-users-search form-control rounded mt-1 '>
                            <option value="all">{{ __('messages.All') }}</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchAttandanceUsersToRoom(user_id = null) {
