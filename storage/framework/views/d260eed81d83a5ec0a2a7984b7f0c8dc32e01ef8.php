...
<?php echo e(__('messages.Qualified users')); ?>
...
<div class="rooms-container">
    <div class="dashboard-header">
        <div class="dashboard-title">
            ...
            <h1><?php echo e(__('messages.Qualified users')); ?></h1>
        </div>
    </div>
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <p id="total-users"><?php echo e($users->count()); ?></p>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row py-3"><div class="col-lg-6">
                    <div class="dashboard-filters">
                        <span class="pt-2"><?php echo e(__('messages.Hours')); ?></span>
                            ...
                            <?php if(isset($users) && $users->count()): ?>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($user->title .' '. $user->first_name); ?></td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchAttandanceUsersToRoom() {
        ...
        fetch('<?php echo e(route("day.get.qualified-users")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/laila/resources/views/admin/days/qualified.blade.php ENDPATH**/ ?>