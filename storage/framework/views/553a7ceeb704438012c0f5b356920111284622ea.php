    ...
    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                ...
                <?php if($latestLog && $latestLog->type == 'in'): ?>
            ...
            <td><?php echo $user->calculateAveragePresence($room->id)['avg']; ?></td>
            <td><?php echo $user->calculateAveragePresence($room->id)['sum']; ?></td>
            <td>
...
<?php endif; ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/laila/resources/views/admin/rooms/attandance-users.blade.php ENDPATH**/ ?>